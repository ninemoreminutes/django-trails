...
# Django-Trails
#from .utils import serialize_instance, record_trail
...
model_added = Signal(providing_args=['instance', 'instance_text', 'raw', 'using', 'data'])
model_changed = Signal(providing_args=['instance', 'instance_text', 'raw', 'using', 'data'])
model_deleted = Signal(providing_args=['instance', 'instance_text', 'raw', 'using', 'data'])
